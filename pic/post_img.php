...
$sql="INSERT INTO `yy_post`(`uid`, `ptext`, `purl`, `ptime`, `plongitude`, `platitude`) VALUES ($uid,'$ptext','$purl','$ptime',$plongitude, $platitude)";
//echo $sql;
MySQL_query($sql);

$b="select * from `yy_post` where `ptime`='$ptime' and uid=$uid";
